...
public class PlayerController : MonoBehaviour
{
    ...
    public List<Button> btnBuySkins;
    public TextMeshProUGUI textPlayerGold;
    public TextMeshProUGUI textPlayerLevel;
    public TextMeshProUGUI textPlayerStackCapacity;
    public TextMeshProUGUI textPunchPower;
    public Button btnBuyLevels;
    public Button btnBuyPunchPower;
    public FixedJoystick joystick;

    [Header("                                    Player Stuff")]
    public float runSpeed = 4f;
    public GameObject levelUPFloor;
